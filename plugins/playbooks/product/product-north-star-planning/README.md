...
`grill@grill`、`product-north-star@product-planning`、`write-doc@write-doc`、`write-doc-cleanup@write-doc`。versionは固定せず、解決先のmanifest identityと必要なskillまたはplaybookを検査する。
